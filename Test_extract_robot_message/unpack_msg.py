...
class unpackege:
    ...
    def __init__(self, robot_data):
        ...
        print("============================================")
        i = 0
        while len(robot_data) > 0:
            self.length = self.get_package_length(robot_data)
            self.type = self.get_package_type(robot_data)
            print("Robot message length = ", self.length)
            print("Robot message type = ", self.type)
            if self.type == 16:
                ...
                while self.current_position < self.length:
                    if self.subtype == 0:
                        ...
                        if self.sublength == 9:
                            self.KINEMATICS_INFO = self.Kinematics_Info_Single(
                                robot_data
                            )
                        else:
                ...
                while self.current_position < self.length:
                    if self.subtype == 0:
                        ...
                        self.REQUEST_VALUE_MESSAGE = self.Request_Value_Message(
                            robot_data
                        )
                        ...
                        self.PROGRAM_THREADS_MESSAGE = self.Program_Threads_Message(
                            robot_data
                        )
                    i += 1
                    print(i)
                ...
                print("The message type is not supported!")
    ...
    def get_subpackage_length(self, robot_data):
        ...
        subpackage_length = struct.unpack_from(lenght_header, robot_data)[0]
    ...
    def get_subpackage_type(self, robot_data):
        ...
        subpackage_type = struct.unpack_from(type_header, robot_data, 4)[0]
